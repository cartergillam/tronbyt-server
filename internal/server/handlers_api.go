...
func (s *Server) SetupAPIRoutes() {
	...
	s.Router.Handle("GET /v0/devices/{id}/market-credential", s.APIAuthMiddleware(s.RequireMobileControlAPI(s.RequireDevice(s.handleGetMarketCredential))))
	s.Router.Handle("PUT /v0/devices/{id}/market-credential", s.APIAuthMiddleware(s.RequireOwnerAPI(s.RequireDevice(s.handlePutMarketCredential))))
